// use ast::{Expr, Name, Op, Pat, Stmt, Unary, Value};

// pub fn gen_program(program: &mut Vec<Stmt>) -> String {
//     let mut out = String::new();
//     for stmt in program {
//         let code = match stmt {
//             Stmt::Var(pat, expr) => gen_global_var(pat, expr),
//             _ => "".to_string(),
//         };
//         out = format!("{}{}", out, code);
//     }
...
// fn gen_global_var(pat: &Pat, expr: &mut Expr) -> String {
...
//     match stmt {
//         Stmt::Var(Pat::Id(name), expr) => format!(
//             "(local {} f32) (set_local {} {})",
//             name,
//             name,
//             gen_expr(expr)
